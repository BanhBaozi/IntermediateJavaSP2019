...
public class DroneDataService extends HttpServlet{
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Call weather API.
            URL url = new URL("http://127.0.0.1:8080/dronereconportal/PortalDBService?area_id=" +sAreaid+"&tilex="+iTileX+"&tiley="+iTileY+"&r="+r+"&g="+g+"");
        ...
        if(iTileY % 2 == 0) //checking when on an even tile
        {
