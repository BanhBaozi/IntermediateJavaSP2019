...
public class GameGrid {
    ...
    public void run() {
        ...
        while (exitWhen == true) {
            ...
            linkedList.addNode(iUserRow, iUserCol);
        ...
        while (linkedList.headNode != null) {
            moves++;
            Node temp;
            temp = linkedList.removeHeadNode();
            iGameGrid[temp.xPosition][temp.yPosition] = 50;
        }
        ...
        //Print result with moves counted

        System.out.println("Your total moves: " + moves);
